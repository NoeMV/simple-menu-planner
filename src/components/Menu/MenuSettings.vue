...
<template>
    <div class="relative py-8 px-10 w-full items-center space-y-8 bg-slate-100 rounded-xl shadow-xl">
        ...
        <div class="flex justify-center space-x-3">
            <button @click="currentTab = 'participantes'" class="py-1 px-1 sm:px-2 font-signika-negative font-medium text-base sm:text-lg ease-in-out duration-75" :class="currentTab == 'participantes' ? ['text-sky-600 border-sky-600 border-b-4 hover:text-sky-800 hover:border-sky-800'] : ['text-slate-700 border-b-2 border-slate-700 hover:border-slate-800 hover:text-slate-800 hover:border-b-4']">
                Participantes
            </button>
            <button @click="currentTab = 'solicitudes'" class="py-1 px-1 sm:px-2 font-signika-negative font-medium text-base sm:text-lg ease-in-out duration-75" :class="currentTab == 'solicitudes' ? ['text-sky-600 border-sky-600 border-b-4 hover:text-sky-800 hover:border-sky-800'] : ['text-slate-700 border-b-2 border-slate-700 hover:border-slate-800 hover:text-slate-800 hover:border-b-4']">
                Solicitudes
            </button>
            <button @click="currentTab = 'bloqueados'" class="py-1 px-1 sm:px-2 font-signika-negative font-medium text-base sm:text-lg ease-in-out duration-75" :class="currentTab == 'bloqueados' ? ['text-sky-600 border-sky-600 border-b-4 hover:text-sky-800 hover:border-sky-800'] : ['text-slate-700 border-b-2 border-slate-700 hover:border-slate-800 hover:text-slate-800 hover:border-b-4']">
                Bloqueados
            </button>
        </div>

        <div v-if="currentTab == 'participantes'" class="space-y-3">
        ...
        <div v-if="currentTab == 'solicitudes'" class="space-y-3">
        ...
        <div v-if="currentTab == 'bloqueados'" class="space-y-3">
            <p class="font-medium font-signika-negative text-slate-700 text-center text-lg sm:text-2xl">
                Bloqueados
            </p>
