        ...
        <div class="py-14 px-10 w-fit flex flex-col justify-center bg-slate-100 rounded-xl shadow-xl">
            ...
            <form class="flex flex-col items-center justify-center w-full px-6 mt-8" @submit.prevent="userStore.register(name, email, password)">
                <div class="mb-6 relative w-full">
                    <input type="name" autocomplete="off" id="name" placeholder="name" v-model="name" class="peer mt-0 w-full bg-white border border-slate-300 px-2.5 py-1 rounded-xl placeholder:text-transparent focus:border-sky-600 focus:ring-2 focus:ring-offset-0 focus:ring-offset-sky-600 focus:ring-opacity-60">
                ...
                <div class="mb-6 relative w-full">
                    <input type="email" autocomplete="off" id="email" placeholder="email" v-model="email" class="peer mt-0 w-full bg-white border border-slate-300 px-2.5 py-1 rounded-xl placeholder:text-transparent focus:border-sky-600 focus:ring-2 focus:ring-offset-0 focus:ring-offset-sky-600 focus:ring-opacity-60">
                    <label for="email" class="absolute -top-[0.3rem] bg-slate-100 leading-none left-2.5 origin-left -translate-y-1/2 transform text-sm text-center text-slate-700 transition-all duration-100 ease-in-out font-signika-negative peer-placeholder-shown:bg-white peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-600 peer-focus:bg-slate-100 peer-focus:leading-none peer-focus:-top-[0.3rem] peer-focus:px-0.5 peer-focus:text-sm peer-focus:text-slate-800">
                        Email
                    </label>
                </div>
                <div class="mb-6 relative w-full">
                    <input type="password" autocomplete="off" id="password" placeholder="password" v-model="password" class="peer mt-0 w-full bg-white border border-slate-300 px-2.5 py-1 rounded-xl placeholder:text-transparent focus:border-sky-600 focus:ring-2 focus:ring-offset-0 focus:ring-offset-sky-600 focus:ring-opacity-60">
