...
<template>
    <div class="mx-auto max-w-7xl h-full flex justify-center items-center">
        <div class="py-14 px-10 w-fit flex flex-col justify-center bg-slate-100 rounded-xl shadow-xl">
            <h1 class="font-signika-negative font-semibold text-3xl text-center text-slate-600">Iniciar sesión</h1>
            <form class="flex flex-col items-center justify-center w-full px-6 mt-8" @submit.prevent="userStore.login(email, password)">
                ...
                <div class="mb-8 relative w-full">
                    <input type="password" autocomplete="off" id="password" placeholder="password" v-model="password" class="peer mt-1 w-full bg-opacity-0 bg-slate-100 border-b-2 border-slate-600 px-0 py-1 placeholder:text-transparent focus:border-slate-800 focus:outline-none">
